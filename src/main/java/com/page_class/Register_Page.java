...
//	String filepth = System.getProperty("user.dir") + "\\test_data\\excel_sheet_data\\test_data.xlsx";
	...
	public void empty_cred() {
		...
		Utility.assertTextEqualsByElementText(driver, errorFirstname, "First Name must be between 1 and 32 characters!",10);
		
		Utility.assertElementPresent(driver, errorLastname, 10);
		Utility.assertTextEqualsByElementText(driver, errorLastname, "Last Name must be between 1 and 32 characters!",10);
		...
		Utility.assertTextEqualsByElementText(driver, errorPassword, "Password must be between 4 and 20 characters!",10);
